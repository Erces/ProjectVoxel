...
public class HUD : MonoBehaviour
{
    ...
    public void EnterCustoMode(WeaponVirti wpn)
    {
        custoMode = true;
        custoMode_Wpn = wpn;
        ...
        {
            WeaponVirti.CustoParts part = wpn.custoParts[i];
            if(part.point)
            {
    ...
    public void ChoosePart(GameObject item)
    {
        ...
        WeaponVirti.CustoParts part = custoMode_Wpn.custoParts[index];
        ...
        {
            WeaponVirti.CustoParts.Mods mod = part.mods[i];
    ...
    public void ChooseMaterialPart()
    {
        ...
        {
            WeaponVirti.CustoMaterial mat = custoMode_Wpn.custoMaterials[i];
            GameObject obj = Instantiate(hud_custoMode_item, hud_custoMode_content.position, hud_custoMode_content.rotation, hud_custoMode_content);
            obj.SetActive(true);
